...
func New() *cobra.Command {
	...
	f.StringVarP(&dotNetSettings.PackageName, "dotnetName", "", codegen.DefaultName, ".NET package suffix; final = \"<dotnetNamespace>.<TitleCase(dotnetName)>\"")
	f.StringVarP(&goSettings.PackageName, "goName", "", codegen.DefaultName, "name of generated Go package")
	f.StringVarP(&nodejsSettings.PackageName, "nodejsName", "", codegen.DefaultName, "NodeJS package suffix; final = \"<nodejsNamespace><nodejsName>\"")
	f.StringVarP(&pythonSettings.PackageName, "pythonName", "", codegen.DefaultName, "Python package suffix; final = \"<pythonPackagePrefix>_<pythonName>\"")
	f.StringVarP(&javaSettings.PackageName, "javaName", "", codegen.DefaultName, "Java package suffix; final = \"<javaBasePackage>.<javaName>\"")

	f.StringVarP(&dotNetSettings.PackageNamespace, "dotnetNamespace", "", "", ".NET package namespace (default \"Pulumi\"); final = \"<dotnetNamespace>.<TitleCase(dotnetName)>\"")
	f.StringVarP(&nodejsSettings.PackageNamespace, "nodejsNamespace", "", "", "NodeJS package namespace (default \"@pulumi/\", trailing slash included); final = \"<nodejsNamespace><nodejsName>\"")
	f.StringVarP(&pythonSettings.PackageNamespace, "pythonPackagePrefix", "", "", "Python package prefix (default \"pulumi\"); final = \"<pythonPackagePrefix>_<pythonName>\"")
	f.StringVarP(&javaSettings.PackageNamespace, "javaBasePackage", "", "", "Java base package (default \"com.pulumi\"); final = \"<javaBasePackage>.<javaName>\"")
